"""Evaluate a fitted PartitionDgModelOICA on multi-SCC synthetic data.

Similar to evaluate.py but adapted for the multi-SCC experiment wildcards.
Ground truth: the SCC partition computed by Tarjan's algorithm on the true DG.
...
n_sccs_param = int(snakemake.wildcards.n_sccs)
